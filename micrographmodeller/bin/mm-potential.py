...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Calculate electrostatic potential from protein structure file. This "
