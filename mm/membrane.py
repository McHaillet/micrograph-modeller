...
if __name__ == '__main__':
    ...
    support.write_mrc(os.path.join(args.destination, f'{name}_{size}_{args.spacing:.2f}A_solvent-4.530V_real.mrc'),
                      real_fil, args.spacing)
    support.write_mrc(os.path.join(args.destination,
